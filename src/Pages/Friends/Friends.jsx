...
export default function Friends(){
    ...
    return (
        <div class="friends-layout pt-2">
            ...
            {displayTab==="followers" && <div className="followers-layout flex flex-wrap justify-center">
            ...
            {displayTab==="following" && <div className="following-layout flex flex-wrap justify-center">
            <ul className="flex flex-wrap">
                    {following.map((user)=>{
                       return(
                            <li><UserCard user={user}/></li>
